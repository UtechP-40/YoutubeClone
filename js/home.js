...
cards.forEach((card) => {
    const finalCard = generateCard(card.snippet.thumbnails.medium.url, card.duration, card.profile, card.snippet.title, card.snippet.channelTitle, card.views, card.time);
